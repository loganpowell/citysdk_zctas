...
function get_sheet(limit = 14744) {
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            let keys;
            const objectified = (_a = response === null || response === void 0 ? void 0 : response.values) === null || _a === void 0 ? void 0 : _a.reduce((a, c, i) => {
                if (i === 0)
                    return (keys = c), a;
                const [, zip] = c;
...
const merge = (geojson, for_merge, threshold = { "2017-09": "180" }) => {
    const { type, features } = geojson, rest = __rest(geojson, ["type", "features"]);
    let total_addressable_market = 0;
    const f = features.reduce((a, c) => {
        const _a = c.properties, { GEOID10, DP04_0007PE, ALAND10 } = _a, props = __rest(_a, ["GEOID10", "DP04_0007PE", "ALAND10"]), rest = __rest(c, ["properties"]);
        ...
        if (match && gt > lt) {
            ...
            a.push(Object.assign({ properties: Object.assign(Object.assign({ GEOID10,
                    DP04_0007PE,
                    ALAND10,
                    TAM }, match), props) }, rest));
        }
        return a;
    }, []);
...
const mergeData = (limit = 14744) => __awaiter(void 0, void 0, void 0, function* () {
